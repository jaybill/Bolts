...
$tinybrowser['obfuscate'] = 'heeeeeeeeeyyyMACARENA';
...
$tinybrowser['link']['image'] = '/uploads/black-diamond/images/'; // Image links
$tinybrowser['link']['media'] = '/uploads/black-diamond/media/'; // Media links
$tinybrowser['link']['file']  = '/uploads/black-diamond/files/'; // Other file links

// File upload paths
$tinybrowser['path']['image'] = $tinybrowser['link']['image']; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = $tinybrowser['link']['media']; // Media files location
$tinybrowser['path']['file']  = $tinybrowser['link']['file']; // Other files location
...
$tinybrowser['tinymcecss'] = '/themes/admin/default/js/tiny_mce/themes/advanced/skins/default/dialog.css';
