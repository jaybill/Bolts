...
class Bolts_Amazon_FPS_CBUIEditTokenPipeline extends Bolts_Amazon_FPS_CBUIPipeline {
     ...
     */
    function Bolts_Amazon_FPS_CBUIEditTokenPipeline($awsAccessKey, $awsSecretKey) {
        parent::Bolts_Amazon_FPS_CBUIPipeline("EditToken", $awsAccessKey, $awsSecretKey);
    }
