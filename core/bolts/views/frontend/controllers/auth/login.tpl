...
<h3>{t}Log In{/t}</h3>
			<form action="{url}/bolts/auth/login{/url}" method="post">
				<p>	
...
<div class="grid_6 omega">
		...
		<ul><li><a href="{url}/bolts/user/register{/url}" title="{t}Register for an account{/t}">{t}Register for an account{/t}</a></li></ul>

		<h3>{t}Forget your password?{/t}</h3>
		<ul><li><a href="{url}/bolts/user/forgotpassword{/url}" title="{t}Reset your password{/t}">{t}Reset your password{/t}</a></li></ul>
