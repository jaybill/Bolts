...
<div class="grid_4 sidenav">
	...
	<ul>
		...
		{if $success}
			<li><a href="{url}/bolts/useradmin/edit/username/{$user.username}{/url}">{t}Continue Editing{/t}</a></li>
		{else}
...
<div class="grid_12">
	{if !$success}
		<form method="post" action="{url}/bolts/useradmin/edit/username/{$user.username}{/url}" enctype="multipart/form-data">
			{if $is_new}
				<p>
