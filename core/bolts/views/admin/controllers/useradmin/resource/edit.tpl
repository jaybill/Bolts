...
<div class="grid_4 sidenav">
	...
	<ul>
		{foreach from=$modules item=module}
			<li><a href="{url}/bolts/resource/edit/id/{$role.id}/modid/{$module}{/url}">{$module}</a></li>
		{/foreach}	
	</ul>
	<ul>
		<li><a href="{url}/bolts/role/index{/url}">{t}Back to Roles{/t}</a><br /></li>
	</ul>
</div>
<div class="grid_12">
	<form action="{url}/bolts/resource/edit/id/{$role.id}/modid/{$modid}{/url}" method="post">
